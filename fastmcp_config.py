...
FASTMCP_CONFIG = {
    ...
    "include_fastmcp_meta": os.getenv("FASTMCP_INCLUDE_FASTMCP_META", "true").lower() == "true",
    
    # OpenAPI Configuration
    "experimental_enable_new_openapi_parser": os.getenv("FASTMCP_EXPERIMENTAL_ENABLE_NEW_OPENAPI_PARSER", "false").lower() == "true",
    
    # Server Configuration
    "server_name": os.getenv("FASTMCP_SERVER_NAME", "BMC AMI DevX Code Pipeline MCP Server"),
    ...
    "rate_limit_enabled": os.getenv("FASTMCP_RATE_LIMIT_ENABLED", "true").lower() == "true",
    "rate_limit_requests_per_minute": int(os.getenv("FASTMCP_RATE_LIMIT_REQUESTS_PER_MINUTE", "60")),
    ...
    "monitoring_enabled": os.getenv("FASTMCP_MONITORING_ENABLED", "true").lower() == "true",
    "metrics_enabled": os.getenv("FASTMCP_METRICS_ENABLED", "true").lower() == "true",
    
    # Error Handling Configuration
    "error_recovery_enabled": os.getenv("FASTMCP_ERROR_RECOVERY_ENABLED", "true").lower() == "true",
    "max_retry_attempts": int(os.getenv("FASTMCP_MAX_RETRY_ATTEMPTS", "3")),
    
    # Tag-based Filtering Configuration
    "include_tags": set(os.getenv("FASTMCP_INCLUDE_TAGS", "public,api,monitoring,management").split(",")),
    "exclude_tags": set(os.getenv("FASTMCP_EXCLUDE_TAGS", "internal,deprecated").split(",")),
    
    # Custom Routes Configuration
    "custom_routes_enabled": os.getenv("FASTMCP_CUSTOM_ROUTES_ENABLED", "true").lower() == "true",
    ...
    "resource_templates_enabled": os.getenv("FASTMCP_RESOURCE_TEMPLATES_ENABLED", "true").lower() == "true",
    ...
    "bmc_api_base_url": os.getenv("BMC_API_BASE_URL", "https://devx.bmc.com/code-pipeline/api/v1"),
...
def get_fastmcp_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "bmc_api_base_url": os.getenv("BMC_API_BASE_URL", "https://devx.bmc.com/code-pipeline/api/v1"),
        "bmc_api_timeout": int(os.getenv("BMC_API_TIMEOUT", "30")),
        "openapi_spec_path": os.getenv("FASTMCP_OPENAPI_SPEC_PATH", "config/ispw_openapi_spec.json"),
    }
...
def validate_config() -> Dict[str, list]:
    ...
    if auth_enabled and not auth_provider:
        issues.append("FASTMCP_AUTH_PROVIDER is required when authentication is enabled")
...
def print_config_summary() -> None:
    ...
    print(f"Authentication: {'Enabled' if server_config['auth_enabled'] else 'Disabled'}")
