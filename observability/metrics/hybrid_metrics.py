    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "response_times": {
                ...
                "minimum": round(self.min_response_time, 3) if self.min_response_time != float("inf") else 0,
            ...
            "bmc_api": {
                ...
                "avg_response_time": (
                    ...
                    if self.bmc_api_response_times else 0
                ),
            },
            "cache": {
...
class OTELMetrics:
    ...
    def record_bmc_api_call(self, operation: str, success: bool, duration: float, 
    ...
    def record_cache_operation(self, operation: str, hit: bool, key_type: Optional[str] = None):
    ...
    def record_auth_attempt(self, provider: str, success: bool, method: Optional[str] = None):
    ...
    def record_elicitation_workflow(self, workflow_name: str, success: bool, 
    ...
    def _get_tool_type(self, tool_name: str) -> str:
        ...
        if tool_name.startswith("ispw_"):
            ...
            return "elicitation"
        elif tool_name in ["get_metrics", "get_health_status", "get_cache_stats", "clear_cache"]:
            return "management"
        else:
            return "custom"
...
class HybridMetrics:
    ...
    def record_elicitation_workflow(self, workflow_name: str, success: bool, 
        ...
        # OTEL metrics
        self.otel.record_elicitation_workflow(workflow_name, success, steps_completed, user_cancelled)
