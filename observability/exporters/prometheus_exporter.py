...
class CustomPrometheusMetrics:
    ...
    def __init__(self, registry: CollectorRegistry):
        ...
        self.fastmcp_info = Info(
            "fastmcp_server_info", "FastMCP server information", registry=registry
        )
        ...
        self.cache_entry_count = Gauge(
            "fastmcp_cache_entry_count", "Number of entries in cache", registry=registry
        )
    ...
    def _initialize_static_info(self):
        ...
        self.otel_status.labels(component="tracing").set(
            1 if config.tracing_enabled else 0
        )
        self.otel_status.labels(component="metrics").set(
            1 if config.metrics_enabled else 0
        )
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            from main import cache, settings
