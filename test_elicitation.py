...
class TestElicitationFeatures:
    ...
    @pytest.mark.asyncio
    async def test_create_assignment_interactive_success(self, mock_settings, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_create_assignment_interactive_cancelled(self, mock_settings, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_deploy_release_interactive_success(self, mock_settings, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_deploy_release_interactive_production_warning(self, mock_settings, mock_context):
    ...
    @pytest.mark.asyncio
    async def test_troubleshoot_assignment_interactive_success(self, mock_settings, mock_context):
        ...
        assert tool_func is not None, "troubleshoot_assignment_interactive tool not found"
