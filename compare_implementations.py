...
def analyze_manual_implementation() -> Dict[str, Any]:
    ...
    for line in lines:
        if 'class BMCAMIDevXClient:' in line:
            ...
            in_class = False
            continue
        elif in_class and line.strip().startswith('def ') and not line.strip().startswith('def _'):
...
def compare_implementations():
    ...
    print(f"  • Efficiency ratio: {openapi['total_tool_count'] / openapi['total_lines']:.2f} tools/line")
